import{_ as a,o as n,c as t,am as p}from"./chunks/framework.CiF4W93w.js";const u=JSON.parse('{"title":"mapstruct 的使用","description":"","frontmatter":{"title":"mapstruct 的使用","excerpt":"摘要","date":"2025-05-29 16:12:20","updated":"2025-05-29 16:12:20"},"headers":[],"relativePath":"框架/企业开发框架/mapstruct 的使用.md","filePath":"框架/企业开发框架/mapstruct 的使用.md","lastUpdated":null}'),e={name:"框架/企业开发框架/mapstruct 的使用.md"};function l(i,s,c,r,o,g){return n(),t("div",null,[...s[0]||(s[0]=[p(`<p>MapStruct 工具</p><p>你看一下项目中的 这个 Mapper 注解，这里使用的就是 package org.mapstruct; 这个框架内容</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>@Mapper  </span></span>
