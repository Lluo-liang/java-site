import{_ as a,o as n,c as p,am as i}from"./chunks/framework._FJXuPhs.js";const E=JSON.parse('{"title":"CompletableFuture方法使用","description":"","frontmatter":{"title":"CompletableFuture方法使用","excerpt":"摘要","date":"2025-06-19 11:56:20","updated":"2025-06-19 11:56:20"},"headers":[],"relativePath":"基础/多线程/CompletableFuture方法使用/index.md","filePath":"基础/多线程/CompletableFuture方法使用/index.md","lastUpdated":null}'),l={name:"基础/多线程/CompletableFuture方法使用/index.md"};function t(e,s,h,r,c,k){return n(),p("div",null,[...s[0]||(s[0]=[i(`<p>CompletableFuture 是在使用线程池的时候经常使用到的一个类，在实际使用的时候，发现在汇总的时候会有一些不同的操作。</p><p>我们直接来看一个示例：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>//并行调用  </span></span>
