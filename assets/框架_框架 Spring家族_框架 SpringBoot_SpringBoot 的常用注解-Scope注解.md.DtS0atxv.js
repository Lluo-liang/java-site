import{_ as n,o as a,c as p,am as e}from"./chunks/framework.CiF4W93w.js";const g=JSON.parse('{"title":"SpringBoot 的常用注解-Scope注解","description":"","frontmatter":{"title":"SpringBoot 的常用注解-Scope注解","excerpt":"摘要","date":"2025-05-24 20:59:16","updated":"2025-05-24 20:59:16"},"headers":[],"relativePath":"框架/框架 Spring家族/框架 SpringBoot/SpringBoot 的常用注解-Scope注解.md","filePath":"框架/框架 Spring家族/框架 SpringBoot/SpringBoot 的常用注解-Scope注解.md","lastUpdated":null}'),l={name:"框架/框架 Spring家族/框架 SpringBoot/SpringBoot 的常用注解-Scope注解.md"};function t(i,s,o,c,r,d){return a(),p("div",null,[...s[0]||(s[0]=[e(`<h3 id="scope-注解的使用场景" tabindex="-1">@Scope 注解的使用场景 <a class="header-anchor" href="#scope-注解的使用场景" aria-label="Permalink to &quot;@Scope 注解的使用场景&quot;">​</a></h3><p>这个注解默认是单例方式，既 singleton，在Spring容器中该实例唯一；还有其他的作用域范围，演示一下大概的使用。</p><p>示例</p><p>业务场景示例</p><h4 id="_1-购物车场景-prototype-作用域" tabindex="-1">1. 购物车场景（Prototype 作用域） <a class="header-anchor" href="#_1-购物车场景-prototype-作用域" aria-label="Permalink to &quot;1. 购物车场景（Prototype 作用域）&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>@Component</span></span>
