import{_ as a,o as n,c as p,am as e}from"./chunks/framework._FJXuPhs.js";const g=JSON.parse('{"title":"Stream","description":"","frontmatter":{"title":"Stream","excerpt":"SpringCloud_组件基本使用_Stream","date":"2023-12-04 23:28:19","updated":"2023-12-04 23:28:19"},"headers":[],"relativePath":"框架/微服务分布式/框架 SpringCloud/Stream.md","filePath":"框架/微服务分布式/框架 SpringCloud/Stream.md","lastUpdated":null}'),l={name:"框架/微服务分布式/框架 SpringCloud/Stream.md"};function t(i,s,o,c,r,d){return n(),p("div",null,[...s[0]||(s[0]=[e(`<p>Stream 组件是用于封装消息队列来使用的，Bus这个组件一般会结合 Stream 使用；</p><p>看一般性文档解释，主要是围绕 Bus 可以做到配置的动态刷新、事件的传递。具体使用的时候可以看一下相关内容。</p><p>下面内容是引用 ChatGpt 的内容，分别是 Stream 和 Bus 的基本使用。</p><h3 id="_1、spring-cloud-stream的使用" tabindex="-1">1、Spring Cloud Stream的使用 <a class="header-anchor" href="#_1、spring-cloud-stream的使用" aria-label="Permalink to &quot;1、Spring Cloud Stream的使用&quot;">​</a></h3><p>Spring Cloud Stream 是一个用于构建消息驱动微服务架构的框架，它基于Spring Boot和Spring Integration，提供了一种简单的方式来实现各个微服务组件之间的消息通信。</p><p>以下是Spring Cloud Stream的基本使用步骤：</p><blockquote><ol><li>引入依赖</li></ol></blockquote><p>在项目的 <code>pom.xml</code> 文件中，添加 Spring Cloud Stream 的依赖：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;dependency&gt;</span></span>
