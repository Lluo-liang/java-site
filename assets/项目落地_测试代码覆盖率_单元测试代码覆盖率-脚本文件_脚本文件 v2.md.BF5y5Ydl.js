import{_ as s,o as a,c as p,am as l}from"./chunks/framework._FJXuPhs.js";const _=JSON.parse('{"title":"脚本文件 v2","description":"","frontmatter":{"title":"脚本文件 v2","excerpt":"摘要","date":"2026-01-09 18:02:17","updated":"2026-01-09 18:02:17"},"headers":[],"relativePath":"项目落地/测试代码覆盖率/单元测试代码覆盖率-脚本文件/脚本文件 v2.md","filePath":"项目落地/测试代码覆盖率/单元测试代码覆盖率-脚本文件/脚本文件 v2.md","lastUpdated":null}'),e={name:"项目落地/测试代码覆盖率/单元测试代码覆盖率-脚本文件/脚本文件 v2.md"};function o(i,n,t,c,u,r){return a(),p("div",null,[...n[0]||(n[0]=[l(`<p>文件： diff_cover_venv.sh</p><p>生成单个模块增量代码识别 jacoco 的文件的覆盖率报告文件</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>#!/usr/bin/env bash  </span></span>
...
<span class="line"><span>}  </span></span>
<span class="line"><span>  </span></span>
<span class="line"><span># ===== 脚本入口 =====</span></span>
<span class="line"><span>main &quot;$@&quot;</span></span></code></pre></div>`,3)])])}const g=s(e,[["render",o]]);export{_ as __pageData,g as default};
