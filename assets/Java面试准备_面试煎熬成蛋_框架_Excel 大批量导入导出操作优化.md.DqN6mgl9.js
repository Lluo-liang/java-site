import{_ as n,o as a,c as p,am as e}from"./chunks/framework.CiF4W93w.js";const h=JSON.parse('{"title":"Excel 大批量导入导出操作优化","description":"","frontmatter":{"title":"Excel 大批量导入导出操作优化","excerpt":"这一篇的主要内容是介绍 Java 对于 Excel 文件的一些基本操作，同时通过实际示例去进行大批量数据导入导出的操作（纯后端）；主要会用到 EasyExcel 和一些常用的操作技术。","date":"2024-01-05 11:27:26","updated":"2024-01-05 11:27:26"},"headers":[],"relativePath":"Java面试准备/面试煎熬成蛋_框架/Excel 大批量导入导出操作优化.md","filePath":"Java面试准备/面试煎熬成蛋_框架/Excel 大批量导入导出操作优化.md","lastUpdated":null}'),l={name:"Java面试准备/面试煎熬成蛋_框架/Excel 大批量导入导出操作优化.md"};function i(t,s,c,r,o,u){return a(),p("div",null,[...s[0]||(s[0]=[e(`<h3 id="_1、java-中的流行库" tabindex="-1">1、Java 中的流行库 <a class="header-anchor" href="#_1、java-中的流行库" aria-label="Permalink to &quot;1、Java 中的流行库&quot;">​</a></h3><p>Java 对 Excel 的常用操作通常涉及读取、创建、编辑和保存 Excel 文件。</p><p>这些操作主要通过 Apache POI 和 jExcelAPI 这两个流行的库来实现。Apache POI 支持老式的 Excel XLS 格式和较新的 XLSX 格式，而 jExcelAPI 主要用于处理 XLS 文件。</p><p>以下是一些常见的操作示例：</p><h4 id="apache-poi" tabindex="-1">Apache POI <a class="header-anchor" href="#apache-poi" aria-label="Permalink to &quot;Apache POI&quot;">​</a></h4><p>Apache POI 是处理 Microsoft Office 文档的流行 Java 库，特别是 Excel 文档（包括 XLS 和 XLSX 格式）。</p><p>POI 提供了不同的模型来处理 Excel 文档，主要包括 HSSF（用于 <code>.xls</code> 格式）、XSSF（用于 <code>.xlsx</code> 格式）以及 SXSSF（用于处理大型 <code>.xlsx</code> 文件的扩展版本）。在处理 <code>.xlsx</code> 格式文件时，主要使用的是 XSSF 和 SXSSF。</p><p>使用示例：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;!-- 基本依赖，仅操作 xls 格式只需引入此依赖 --&gt;</span></span>
