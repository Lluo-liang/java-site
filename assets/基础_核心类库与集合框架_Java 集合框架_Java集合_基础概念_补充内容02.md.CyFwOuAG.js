import{_ as s,o as n,c as p,am as e}from"./chunks/framework._FJXuPhs.js";const u=JSON.parse('{"title":"Java集合_基础概念_补充内容02","description":"","frontmatter":{"title":"Java集合_基础概念_补充内容02","excerpt":"Java集合_基础概念_补充内容02","date":"2023-11-14 12:01:00","updated":"2023-11-14 12:00:00"},"headers":[],"relativePath":"基础/核心类库与集合框架/Java 集合框架/Java集合_基础概念_补充内容02.md","filePath":"基础/核心类库与集合框架/Java 集合框架/Java集合_基础概念_补充内容02.md","lastUpdated":null}'),t={name:"基础/核心类库与集合框架/Java 集合框架/Java集合_基础概念_补充内容02.md"};function l(i,a,c,o,r,h){return n(),p("div",null,[...a[0]||(a[0]=[e(`<h4 id="_1、set集合是如何保证对象不重复的" tabindex="-1">1、Set集合是如何保证对象不重复的？ <a class="header-anchor" href="#_1、set集合是如何保证对象不重复的" aria-label="Permalink to &quot;1、Set集合是如何保证对象不重复的？&quot;">​</a></h4><p>HashSet 的底层采用HashMap来存放数据, 他执行添加元素操作的时候是将元素作为 Map 的Key；</p><p>HashMap保证key的不重复性，对于重复的key，HashMap会根据参数onlyIfAbsent的设置和原value是否为空两个条件来<strong>判断是否替换新value</strong>，</p><p>但要注意的是，对于HashSet，这个value只是个空的Object类的对象，没有任何实际作用，HashSet中的元素实际上是存储在key上的。针对重复的key，<strong>HashMap只有对于value的处理，并不会替换key</strong>，因此在HashSet中加入相同元素不会覆盖。</p><p>源码相关内容：</p><p>HashSet 的添加方法</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public boolean add(E e) {  </span></span>
