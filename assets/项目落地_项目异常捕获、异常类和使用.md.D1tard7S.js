import{_ as n,o as a,c as e,am as t}from"./chunks/framework._FJXuPhs.js";const h=JSON.parse('{"title":"项目异常捕获、异常类和使用","description":"","frontmatter":{"title":"项目异常捕获、异常类和使用","excerpt":"摘要","date":"2025-11-18 11:00:56","updated":"2025-11-18 11:00:56"},"headers":[],"relativePath":"项目落地/项目异常捕获、异常类和使用.md","filePath":"项目落地/项目异常捕获、异常类和使用.md","lastUpdated":null}'),p={name:"项目落地/项目异常捕获、异常类和使用.md"};function l(i,s,o,c,r,d){return a(),e("div",null,[...s[0]||(s[0]=[t(`<h3 id="异常捕获" tabindex="-1">异常捕获 <a class="header-anchor" href="#异常捕获" aria-label="Permalink to &quot;异常捕获&quot;">​</a></h3><h4 id="局部捕获" tabindex="-1">局部捕获 <a class="header-anchor" href="#局部捕获" aria-label="Permalink to &quot;局部捕获&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>try {</span></span>
