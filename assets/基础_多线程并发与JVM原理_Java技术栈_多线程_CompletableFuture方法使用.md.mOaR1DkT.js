import{_ as a,o as n,c as p,am as i}from"./chunks/framework._FJXuPhs.js";const u=JSON.parse('{"title":"CompletableFuture方法使用","description":"","frontmatter":{"title":"CompletableFuture方法使用","excerpt":"摘要","date":"2025-06-19 11:56:20","updated":"2025-06-19 11:56:20"},"headers":[],"relativePath":"基础/多线程并发与JVM原理/Java技术栈_多线程/CompletableFuture方法使用.md","filePath":"基础/多线程并发与JVM原理/Java技术栈_多线程/CompletableFuture方法使用.md","lastUpdated":null}'),l={name:"基础/多线程并发与JVM原理/Java技术栈_多线程/CompletableFuture方法使用.md"};function t(e,s,h,r,c,k){return n(),p("div",null,[...s[0]||(s[0]=[i(`<p>CompletableFuture 是在使用线程池的时候经常使用到的一个类，在实际使用的时候，发现在汇总的时候会有一些不同的操作。</p><p>我们直接来看一个示例：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>//并行调用  </span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><hr><p>看了一下相关的解释，看 平时使用上面的代码示例方式就好了；</p><p>方式一和方式二 的性能差距并不是很明显，可能一般会 在响应式编程链路中需要延续异步特性时使用</p><p>方式二；不过使用方式二的话，可能在线程池触发拒绝策略的时候会有问题（看具体拒绝策略）。</p>`,20)])])}const E=a(l,[["render",t]]);export{u as __pageData,E as default};
