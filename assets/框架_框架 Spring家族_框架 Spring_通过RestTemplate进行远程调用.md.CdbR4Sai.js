import{_ as s,o as a,c as p,am as e}from"./chunks/framework.CiF4W93w.js";const m=JSON.parse('{"title":"通过RestTemplate进行远程调用","description":"","frontmatter":{"title":"通过RestTemplate进行远程调用","excerpt":"通过RestTemplate进行远程调用","date":"2023-11-22 22:44:31","updated":"2023-11-22 22:44:31"},"headers":[],"relativePath":"框架/框架 Spring家族/框架 Spring/通过RestTemplate进行远程调用.md","filePath":"框架/框架 Spring家族/框架 Spring/通过RestTemplate进行远程调用.md","lastUpdated":null}'),t={name:"框架/框架 Spring家族/框架 Spring/通过RestTemplate进行远程调用.md"};function l(i,n,c,o,r,g){return a(),p("div",null,[...n[0]||(n[0]=[e(`<p>RestTemplate 是从 Spring3.0 开始支持的一个 HTTP 请求工具，它提供了常见的REST请求方案的模版。对于远程请求进行了一定封装，从而通过建议配置可以实现远程调用。</p><p>他底层用的是 JDK 的 HTTP 请求</p><ol><li>添加依赖</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;dependency&gt;</span></span>
