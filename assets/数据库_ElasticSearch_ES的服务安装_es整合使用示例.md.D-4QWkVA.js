import{_ as n,o as a,c as t,am as p}from"./chunks/framework._FJXuPhs.js";const q=JSON.parse('{"title":"es整合使用示例","description":"","frontmatter":{"title":"es整合使用示例","excerpt":"摘要","date":"2024-12-24 00:49:26","updated":"2024-12-24 00:49:26"},"headers":[],"relativePath":"数据库/ElasticSearch/ES的服务安装/es整合使用示例.md","filePath":"数据库/ElasticSearch/ES的服务安装/es整合使用示例.md","lastUpdated":null}'),e={name:"数据库/ElasticSearch/ES的服务安装/es整合使用示例.md"};function o(l,s,u,i,r,d){return a(),t("div",null,[...s[0]||(s[0]=[p(`<h3 id="es-整合使用示例" tabindex="-1">ES 整合使用示例 <a class="header-anchor" href="#es-整合使用示例" aria-label="Permalink to &quot;ES 整合使用示例&quot;">​</a></h3><p>Spring Data Elasticsearch是Spring提供的一种以Spring Data风格来操作数据存储的方式，它可以避免编写大量的样板代码。</p><h4 id="常用注解" tabindex="-1">常用注解 <a class="header-anchor" href="#常用注解" aria-label="Permalink to &quot;常用注解&quot;">​</a></h4><p>常用注解说明如下：</p><table tabindex="0"><thead><tr><th></th><th></th><th></th></tr></thead><tbody><tr><td>注解名称</td><td>作用</td><td>参数说明</td></tr><tr><td><a href="/java-site/Document.html">@Document</a></td><td>用于标识映射到Elasticsearch文档上的领域对象</td><td>indexName：索引库的名字，MySQL中数据库的概念</td></tr><tr><td><a href="/java-site/Setting.html">@Setting</a></td><td>ES的配置注解</td><td>shards：默认分片数 <br>replicas：默认副本数量</td></tr><tr><td>@Id</td><td>用于标识文档的ID，文档可以认为是MySQL中表行的概念</td><td>无参数</td></tr><tr><td><a href="/java-site/Field.html">@Field</a></td><td>用于标识文档中的字段，可以认为是MySQL中列的概念</td><td>type：文档中字段的类型 <br>index：是否建立倒排索引 <br>store：是否进行存储 <br>analyzer：分词器的名称</td></tr></tbody></table><p>其中常用的FieldType类型有如下几种：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public enum FieldType {</span></span>
