import{_ as n,o as a,c as e,am as p}from"./chunks/framework._FJXuPhs.js";const b=JSON.parse('{"title":"websocket的基础使用","description":"","frontmatter":{"title":"websocket的基础使用","excerpt":"websocket的基础使用","date":"2024-03-31 16:23:47","updated":"2024-03-31 16:23:47"},"headers":[],"relativePath":"基础/异常处理与IO/NIO/websocket的基础使用.md","filePath":"基础/异常处理与IO/NIO/websocket的基础使用.md","lastUpdated":null}'),t={name:"基础/异常处理与IO/NIO/websocket的基础使用.md"};function l(o,s,i,c,r,d){return a(),e("div",null,[...s[0]||(s[0]=[p(`<p>在Web应用中，WebSocket提供了在单个长时间连接上进行<strong>全双工、双向通讯</strong>的能力(基于HTTP协议)。</p><p>它允许服务器主动向客户端发送信息，适合需要实时功能的应用，如在线聊天、实时通知、游戏等。</p><h3 id="使用示例" tabindex="-1">使用示例 <a class="header-anchor" href="#使用示例" aria-label="Permalink to &quot;使用示例&quot;">​</a></h3><p>添加依赖</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;dependency&gt;</span></span>
