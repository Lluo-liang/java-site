import{_ as n,o as s,c as p,am as e}from"./chunks/framework.CiF4W93w.js";const h=JSON.parse('{"title":"SpringBoot 的常用注解","description":"","frontmatter":{"title":"SpringBoot 的常用注解","excerpt":"摘要","date":"2025-06-15 08:47:12","updated":"2025-06-15 08:47:12"},"headers":[],"relativePath":"框架/框架 Spring家族/框架 SpringBoot/SpringBoot 的常用注解.md","filePath":"框架/框架 Spring家族/框架 SpringBoot/SpringBoot 的常用注解.md","lastUpdated":null}'),l={name:"框架/框架 Spring家族/框架 SpringBoot/SpringBoot 的常用注解.md"};function i(t,a,o,c,r,d){return s(),p("div",null,[...a[0]||(a[0]=[e(`<h3 id="常用注解" tabindex="-1">常用注解 <a class="header-anchor" href="#常用注解" aria-label="Permalink to &quot;常用注解&quot;">​</a></h3><p>后续有空可以更新一下导图内容</p><p><a href="/java/框架/框架 Spring家族/框架 SpringBoot/SpringBoot 的常用注解——导图.html">导图</a></p><hr><h3 id="组件相关注解" tabindex="-1">组件相关注解 <a class="header-anchor" href="#组件相关注解" aria-label="Permalink to &quot;组件相关注解&quot;">​</a></h3><h4 id="controller" tabindex="-1">@Controller <a class="header-anchor" href="#controller" aria-label="Permalink to &quot;@Controller&quot;">​</a></h4><p>用于修饰MVC中<code>controller</code>层的组件，SpringBoot中的组件扫描功能会识别到该注解，并为修饰的类实例化对象，通常与<code>@RequestMapping</code>联用，当SpringMVC获取到请求时会转发到指定路径的方法进行处理。</p><p>使用示例</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// Controller 调用 Service 和 Repository</span></span>
