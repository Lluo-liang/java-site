import{_ as a,o as n,c as p,am as e}from"./chunks/framework._FJXuPhs.js";const r=JSON.parse('{"title":"常用搜索语句","description":"","frontmatter":{"title":"常用搜索语句","excerpt":"摘要","date":"2025-06-18 15:33:00","updated":"2025-06-18 15:33:00"},"headers":[],"relativePath":"数据库/搜索分析数据库/技术栈 ElasticSearch/常用搜索语句.md","filePath":"数据库/搜索分析数据库/技术栈 ElasticSearch/常用搜索语句.md","lastUpdated":null}'),l={name:"数据库/搜索分析数据库/技术栈 ElasticSearch/常用搜索语句.md"};function t(o,s,c,i,u,d){return n(),p("div",null,[...s[0]||(s[0]=[e(`<h3 id="搜索入门" tabindex="-1">搜索入门 <a class="header-anchor" href="#搜索入门" aria-label="Permalink to &quot;搜索入门&quot;">​</a></h3><h4 id="搜索全部" tabindex="-1">搜索全部 <a class="header-anchor" href="#搜索全部" aria-label="Permalink to &quot;搜索全部&quot;">​</a></h4><ul><li>最简单的搜索，使用<code>match_all</code>来表示，例如搜索全部；</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>GET /bank/_search</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p><img src="https://obsidian-picture.oss-cn-shenzhen.aliyuncs.com/luoblog/20240728234108.png" alt="image.png"></p><h3 id="条件搜索" tabindex="-1">条件搜索 <a class="header-anchor" href="#条件搜索" aria-label="Permalink to &quot;条件搜索&quot;">​</a></h3><h4 id="精确匹配-term-terms" tabindex="-1"><strong>精确匹配（Term/Terms）</strong> <a class="header-anchor" href="#精确匹配-term-terms" aria-label="Permalink to &quot;**精确匹配（Term/Terms）**&quot;">​</a></h4><p><code>term</code>：精确匹配字段值（不分词），如查找<code>name</code>为<code>&quot;python&quot;</code>的文档</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>{ &quot;query&quot;: { &quot;term&quot;: { &quot;name&quot;: &quot;python&quot; } } }</span></span></code></pre></div><p><code>terms</code>：匹配多个值，如<code>name</code>为<code>&quot;python&quot;</code>或<code>&quot;android&quot;</code></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>{ &quot;query&quot;: { &quot;terms&quot;: { &quot;name&quot;: [&quot;python&quot;, &quot;android&quot;] } } }</span></span></code></pre></div><h5 id="精准匹配-加了一个嵌套字段查询" tabindex="-1">精准匹配 加了一个嵌套字段查询 <a class="header-anchor" href="#精准匹配-加了一个嵌套字段查询" aria-label="Permalink to &quot;精准匹配 加了一个嵌套字段查询&quot;">​</a></h5><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>GET /soms_skc_question_alias/_search</span></span>
<span class="line"><span>{</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>精准匹配，且加了一个嵌套字段查询，返回全部字段</p><h4 id="范围查询-range" tabindex="-1">范围查询 <strong>Range</strong> <a class="header-anchor" href="#范围查询-range" aria-label="Permalink to &quot;范围查询 **Range**&quot;">​</a></h4><p>查询数字或日期范围，如<code>age</code>在18到30之间</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>{ </span></span>
<span class="line"><span>  &quot;query&quot;: { </span></span>
